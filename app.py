...
class AssistantUI:
    def __init__(self):
        ...
        self.translations = {
            "English": {
                "placeholder": "Ask your question about Prime Minister Anwar Ibrahim...",
                "ask_button": "Ask",
                "creative_button": "I'm Feeling Creative",
                "suggested_questions": "Suggested Questions",
                "suggestions": [
                    "What are Anwar Ibrahim's key reforms as Prime Minister?",
                    "How has MADANI Malaysia evolved under his leadership?",
                    "What are his main economic policies?",
                    "How does he approach international relations?"
                ],
            ...
            "Bahasa Melayu": {
                "placeholder": "Tanya soalan anda tentang Perdana Menteri Anwar Ibrahim...",
                "ask_button": "Tanya",
                "creative_button": "Rasa Kreatif",
                "suggested_questions": "Soalan Dicadangkan",
                "suggestions": [
                    "Apakah reformasi utama Anwar Ibrahim sebagai Perdana Menteri?",
                    "Bagaimana Malaysia MADANI berkembang di bawah kepimpinannya?",
                    "Apakah dasar-dasar ekonomi utama beliau?",
                    "Bagaimana pendekatan beliau dalam hubungan antarabangsa?"
                ],
            ...
            "中文": {
                "placeholder": "询问有关Prime Minister Anwar Ibrahim的问题...",
                "ask_button": "询问",
                "creative_button": "创意灵感",
                "suggested_questions": "建议问题",
                "suggestions": [
                    "Anwar Ibrahim作为总理的主要改革是什么？",
                    "在领导下的马来西亚MADANI如何发展？",
                    "他的主要经济政策是什么？",
                    "他如何处理国际关系？"
                ],
            ...
            "தமிழ்": {
                ...
                "suggestions": [
                    ...
                    "அவர் விரிவாக்க வழியாக இருப்பது என்ன?"
                ],
    ...
    def get_creative_prompt(self, selected_language: str) -> str:
        ...
        creative_prompts = {
            ...
            "தமிழ்": [
                ...
                "இ���்த பகுதியில் பயன்படுத்தப்படும் விஷுவல் கதை சொல்லும் நுட்பங்களை கண்டறியவும்",
...
Remember: The primary goal is to provide precise, clean timestamps with accurate content analysis while maintaining absolute consistency in format and presentation. Never include source references or annotations with timestamps."""
    ...
    def run(self):
        ...
        st.set_page_config(page_title="ime Minister Anwar Ibrahim Enhanced Chat Assistant by BlacX", layout="centered")
        ...
        st.markdown("""
            ...
            <div class="big-font">Prime Minister Anwar Ibrahim Enhanced Chat Assistant by BlacX</div>
